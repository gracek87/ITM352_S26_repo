# Define a list of survey response values (5, 7, 3, 8)
...
responseValues = [(1012, 5), (1035, 7), (1021, 3), (1053, 8)]
responseValues.sort()
print("Sorted survey responses with respondent IDs:", responseValues)
